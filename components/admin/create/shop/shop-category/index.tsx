...
import {
    ...
    fetchShopCategories,
    ShopCategory,
} from '@/actions/admin/shop/shop-category.actions';
...
const ShopCategoryManagement = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (editingCategory) {
                result = await updateShopCategory(editingCategory.id, categoryData);
                if (result.success) {
                    setCategories((prev) =>
                ...
                result = await createShopCategory(categoryData);
    ...
    return (
        <div className="w-full p-6 space-y-6">
            <Card className="w-full">
                <CardHeader>
                    <CardTitle>{editingCategory ? 'Edit' : 'Create'} Shop Category</CardTitle>
                    <CardDescription>
                        {editingCategory ? 'Modify' : 'Add'} a shop category with title, description, and image
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card className="w-full">
                <CardHeader>
                    ...
                    <CardDescription>List of existing shop categories</CardDescription>
                    <div className="mt-4">
                        <Input
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                This will permanently delete the shop category.
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
